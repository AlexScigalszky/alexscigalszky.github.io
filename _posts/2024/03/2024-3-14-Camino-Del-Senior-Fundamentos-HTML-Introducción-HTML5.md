...
<html>
    ...
    <body>
        ...
        <input id="check-1" type="checkbox"><label for="check-1">Check 1</label>
        <input id="check-2" type="checkbox"><label for="check-2">Check 2</label>
        <input id="check-3" type="checkbox"><label for="check-3">Check 3</label>

        
        <input id="radio-2" name="radio" type="radio" checked><label for="radio-2">Radio 2</label>
        <input id="radio-3" name="radio" type="radio"><label for="radio-3">Radio 3</label>
